...
import { fee } from '../../../fee/redux/reducers';

SwiperCore.use([EffectCoverflow, Pagination]);

const ListPostSell = (props) => {
    const { post } = props
    ...
    return (
        <div
            className="section home-properties has-bg"
        >
            ...
            <div>
                ...
                >
                    {post?.listPosts?.length !== 0 ?
                        post?.listPosts.filter(postItem => postItem.type === 1).map((postItem, i) => {
                            return (
                                <SwiperSlide key={i} >
                                        ...
                                        <Link to={`/detail/${slug(postItem.title)}.${postItem._id}.html`}>
                                            ...
                                            >
                                                ...
                                                <div className="property-card__if">
                                                    ...
                                                    <span >~{FormatMoney(postItem.price / postItem.acreage)}/m<sup>2</sup></span>
...
export default connect(mapStateToProps, mapDispatchToProps)(ListPostSell);
